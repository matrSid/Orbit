...
class StudySessionService : Service() {
    ...
    companion object {
        ...
        const val CHANNEL_ID     = "wick_session"
        const val ACTION_START   = "wick.START_SESSION"
        const val ACTION_STOP    = "wick.STOP_SESSION"
        ...
        fun buildNotification(context: Context): Notification {
            ...
            return Notification.Builder(context, CHANNEL_ID)
                ...
                .setContentTitle("Wick — session in progress")
