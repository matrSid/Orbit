...
fun OrbitBottomBar(
    ...
    Column(
        ...
        Box(Modifier.fillMaxWidth().height(1.dp).background(OrbitColors.hairline))
                ...
                Row(Modifier.fillMaxWidth().height(60.dp)) {
                    ...
                    items.forEachIndexed { index, label ->
                        ...
                        Box(
                            ...
                            Text(
                                text = label,
                                style = if (selected) OrbitType.bodyStrong else OrbitType.body,
